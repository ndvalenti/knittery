...
//    let price: Double?
    ...
    init(id: Int?, name: String?, author: Author?, free: Bool = false, craft: Craft?, difficulty: Double = 0.0, rating: Double = 0.0, personalAttributes: PersonalAttributes?, yardage: Int?, photos: [Photo], createdAt: String?, url: String?, permalink: String?, notes: String?) {
        self.id = id
        self.name = name
        self.author = author
        self.free = free
...
extension Pattern {
    static let mockData = Pattern(id: 688190, name: "Speckled Super Scarf", author: Author.mockData, free: true, craft: Craft.mockData, difficulty: 2.29, personalAttributes: PersonalAttributes.mockData, yardage: 708, photos: [Photo.mockData, Photo.mockData, Photo.mockData], createdAt: "2016/09/06 14:58:22 -0400", url: "https://www.yarnspirations.com/row-en/red-heart-speckled-super-scarf/RHC0125-024654M.html", permalink: "speckled-super-scarf",
